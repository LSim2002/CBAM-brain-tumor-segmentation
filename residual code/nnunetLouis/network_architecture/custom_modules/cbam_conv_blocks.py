...
from nnunet.network_architecture.custom_modules.conv_blocks import ResidualBottleneckBlock
...
class ResidualCBAMLayer(nn.Module):
    def __init__(self, input_channels, output_channels, kernel_size, network_props, cbam_props, num_blocks, first_stride=None, cbam_ratio=16,
