...
from nnunet.network_architecture.generic_modular_cbam_UNet import PlainConvCBAMUNet, get_default_network_cbam_config
...
class nnUNetTrainerV2_CbamUNet(nnUNetTrainerV2):
    def initialize_network(self):
        ...
        self.network = PlainConvCBAMUNet(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
                                   pool_op_kernel_sizes, conv_kernel_sizes, cfg, cbam_props, self.num_classes,
                                   blocks_per_stage_decoder, True, False, 512, InitWeights_He(1e-2))
