...
## a modifier!!
def get_default_network_cbam_config(dim=2, dropout_p=None, nonlin="ReLU"):
    """
    ...
    #pour le spatial module, on poole sur l'axe des channels (toujours 1)
    props['spatial_mean_op_kwargs'] =  {'dim': 1, 'keepdim': False}
    props['spatial_max_op_kwargs'] =  {'dim': 1, 'keepdim': False}
